         ...
         <h3><i class="fa fa-edit"></i> {{ trans('dashboard.Menu') }}</h3>
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    ...
                    <a href="{{ action('Admin\Menu\admin_menu_controller@getIndex') }}" ><span class="nav-label">{{ trans('dashboard.Menu') }}</span></a>
                </li>
                <li>
...
<div class="col-lg-12">
        <div class="ibox">
            <div class="card-box">
                ...
                <form class="form-horizontal blog-form" role="form" method="POST" action="{{ action('Admin\Menu\admin_menu_controller@postSave') }}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
