    ...
    <section class="widget">
        <div class="ibox-title">
                                ...
                                <div class="row"  align="right" style="margin-bottom: 10px;">
                                      <a href="{{ action('Admin\Menu\admin_menu_controller@getCreate') }}"><span class="btn btn-primary btn-xs"> <i class="fa fa-plus"></i> Add menu</span></a>
                ...
                <div class="mt">
                    ...
                    <table id="data-table" class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th class="no-sort hidden-sm-down">Title</th>
                            <th class="no-sort hidden-sm-down">parent_id</th>
