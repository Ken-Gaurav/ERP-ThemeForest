                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    ...
                                    <div class="m-l-10">
                                        <h4 class="m-b-0">{{strtoupper(Auth()->User()->name)}}</h4>
...
<!-- 1 Level start-->
            @foreach($categories as $item)
                     ...
                     @if($item->children->count() >= 0 )          
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark sidebar-link" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-image-filter-tilt-shift"></i><span class="hide-menu"> {{ $item->title }} </span></a>
                            <ul aria-expanded="false" class="collapse first-level">
<!-- 2 Level start-->          
                                    @foreach($item->children as $submenu1)

                                         @if($submenu1->children->count() >=0)   
                                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-chemical-weapon"></i><span class="hide-menu">{{ $submenu1->title }} </span></a>
                                 ...
                                 @foreach($submenu1->children as $submenu2)
                                        ...
                                        <li class="sidebar-item"><a href="chart-c3-axis.html" class="sidebar-link"><i class="mdi mdi-arrange-bring-to-front"></i> <span class="hide-menu">{{ $submenu2->title }} </span></a>
