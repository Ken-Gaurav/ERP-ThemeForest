...
@section('content')          
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-pills custom-pills owm" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#users" role="tab" aria-selected="true">
                                            <span class="text-muted">Users</span>
                                            <h3 class="m-b-0 text-dark">15K <span class="text-info font-12"><i class="mdi mdi-arrow-up"></i>18.6</span></h3>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#revenue" role="tab" aria-selected="false">
                                            <span class="text-muted">Revenue</span>
                                            <h3 class="m-b-0 text-dark">$945 <span class="text-orange font-12"><i class="mdi mdi-arrow-down"></i>43.6</span></h3>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#conversion" role="tab" aria-selected="false">
                                            <span class="text-muted">Conversion</span>
                                            <h3 class="m-b-0 text-dark">0.23% <span class="text-orange font-12"><i class="mdi mdi-arrow-down"></i>28.6</span></h3>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-lg-4">
                                        <div class="d-flex align-items-center">
                                            <div class="m-r-10"><a class="btn btn-circle btn-lg btn-cyan text-white">EA</a></div>
                                            <div class="text-white">
                                                <span class="font-14 op-5 d-block">Product A</span><span class="font-16 font-medium">$15.56K</span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Column -->
                                    ...
                                    <div class="col-sm-12 col-lg-4">
                                        <div class="d-flex no-block align-items-center">
                                            <div class="m-r-10"><a class="btn btn-circle btn-lg btn-cyan text-white">EA</a></div>
                                            <div class="text-white">
                                                <span class="font-14 op-5 d-block">Product B</span><span class="font-16 font-medium">$15.56K</span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Column -->
                                    ...
                                    <div class="col-sm-12 col-lg-4">
                                        <div class="d-flex no-block align-items-center">
                                            <div class="m-r-10"><a class="btn btn-circle btn-lg btn-cyan text-white">EA</a></div>
                                            <div class="text-white">
                                                <span class="font-14 op-5 d-block">Product C</span><span class="font-16 font-medium">$15.56K</span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Column -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-lg-4">
                        <div class="card">
                            <div class="card-body text-center">
                                <div class="profile-pic m-b-20 m-t-20">
                                    <img src="/assets/assets/images/users/5.jpg" width="150" class="rounded-circle" alt="user" />
                        ...
                        <!-- Card with image -->
                        <div class="card">
                            <img class="card-img-top" src="/assets/assets/images/big/img1.jpg" alt="card">
                            <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="profiletimeline">
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="/assets/assets/images/users/1.jpg" alt="user" class="rounded-circle" /> </div>
                                        <div class="sl-right">
                                            <div><a href="javascript:void(0)" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                <p>assign a new task <a href="javascript:void(0)"> Design weblayout</a></p>
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-6 m-b-20"><img src="/assets/assets/images/big/img1.jpg" alt="" class="img-fluid rounded" /></div>
                                                    <div class="col-lg-3 col-md-6 m-b-20"><img src="/assets/assets/images/big/img2.jpg" alt="" class="img-fluid rounded" /></div>
                                                    <div class="col-lg-3 col-md-6 m-b-20"><img src="/assets/assets/images/big/img3.jpg" alt="" class="img-fluid rounded" /></div>
                                                    <div class="col-lg-3 col-md-6 m-b-20"><img src="/assets/assets/images/big/img4.jpg" alt="" class="img-fluid rounded" /></div>
                                                </div>
                                    ...
                                    <hr>
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="/assets/assets/images/users/2.jpg" alt="user" class="rounded-circle" /> </div>
                                        <div class="sl-right">
                                            <div> <a href="javascript:void(0)" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                <div class="m-t-20 row">
                                                    <div class="col-md-3 col-12"><img src="/assets/assets/images/big/img1.jpg" alt="user" class="img-fluid rounded" /></div>
                                    ...
                                    <hr>
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="/assets/assets/images/users/3.jpg" alt="user" class="rounded-circle" /> </div>
                                        <div class="sl-right">
                                            <div><a href="javascript:void(0)" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                    ...
                                    <hr>
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="/assets/assets/images/users/4.jpg" alt="user" class="rounded-circle" /> </div>
                                        <div class="sl-right">
                                            <div><a href="javascript:void(0)" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
